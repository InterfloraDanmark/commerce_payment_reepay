  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    try {
      ...
      if (!$checkoutSession instanceof ReepayCheckoutSession) {
        throw new \Exception($this->t('No session returned from API.', [], ['context' => 'Reepay']));
      }
    }
      ...
      drupal_set_message($this->t('An error occured please try again or contact customer support.'));
